...
sampleThreeCombined_df = generateData.sampleThreeCombined_df

# Split the dataframe into two lists based on category
african_list = sampleThreeCombined_df[sampleThreeCombined_df['Category'] == 'African']
non_african_list = sampleThreeCombined_df[sampleThreeCombined_df['Category'] == 'Non-African']
