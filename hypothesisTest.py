...
sampleOneCombined_df = generateData.sampleOneCombined_df

# Split the dataframe into two lists based on category
african_list = sampleOneCombined_df[sampleOneCombined_df['Category'] == 'African']
non_african_list = sampleOneCombined_df[sampleOneCombined_df['Category'] == 'Non-African']
